...
df=pandas.DataFrame([],columns=['姓名',"就讀學校",'尺寸','生日','性別','郵箱','手機','身分證字號','家人手機','家人身分證字號','與家人關係','葷素','重大疾病'])
for i in results:
    print(i)
    df.loc[len(df.index)]={"姓名":i['name'],"就讀學校":i['old_school'],'尺寸':i['size'],"生日":i['birth'],'性別':i['sex'],'郵箱':i['email'],'手機':i['phone'],'身分證字號':i['ID'],'家人手機':i['parentPhone'],'家人身分證字號':i['parentID'],'與家人關係':i['parentRelation'],'葷素':i['eat'],'重大疾病':i['sick']}
